...
**成熟と繁殖**:
個体は一定の年齢に達すると繁殖可能になります。繁殖には以下の条件が必要です：

**繁殖の条件**:
1. **成熟年齢**: 12歳以上（生物学的年齢）
2. **エネルギー**: 最大エネルギーの40%以上
3. **HP**: 最大HPの40%以上
4. **繁殖クールダウン**: 前回の繁殖から一定期間経過
...
シミュレーション内の時間は現実世界の時間を圧縮して表現しています。

**基本換算レート**:
- **1年（生物学的年齢）= 0.75秒（実時間）= 45フレーム**
- 60 FPS で動作

**主要なライフイベントと実時間**:

| イベント | 生物学的年齢 | 実時間 | フレーム数 |
|----------|--------------|--------|------------|
| 成熟（繁殖可能） | 12歳 | 9秒 | 540フレーム |
| 繁殖クールダウン（ゴリラ/ボノボ） | 3年 | 2.25秒 | 135フレーム |
| 繁殖クールダウン（チンパンジー） | 2年 | 1.5秒 | 90フレーム |
| 寿命（ゴリラ/ボノボ） | 40歳 | 30秒 | 1800フレーム |
| 寿命（チンパンジー） | 35歳 | 26.25秒 | 1575フレーム |

**エネルギー代謝**:
- チンパンジー（max_energy=120）は食料なしで約12秒で完全枯渇
- 代謝率: 0.01667 energy/frame（1.0 energy/second）
- エネルギーが20%以下になるとHPに飢餓ダメージ
